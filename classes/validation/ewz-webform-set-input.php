...
class Ewz_Webform_Set_Input extends Ewz_Input
{
     ...
     function __construct( $form_data ) {
         ...
         $this->rules = array(
                  ...
                  'ewzmode'        =>  array( 'type' => 'fixed',      'req' => true,  'val' => 'wf_set' ),
                  'action'         => array( 'type' => 'fixed',       'req' => true, 'val' => 'ewz_save_webform_order' ),
                  'ewznonce'       =>  array( 'type' => 'anonce',     'req' => true,  'val' => '' ),
                  'wforder'        =>  array( 'type' => 'v_order',   'req' => true,  'val' => '' ),
                  );
        $this->validate();
     }
    ...
    function v_order( $value, $arg ) {
        ...
        if ( is_array( $value ) ) {
            ...
            throw new EWZ_Exception( "Bad input data for webform order" );
        }
        return true;
     }
}
